      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          ...
          className={`text-sm flex items-center px-2 py-1 rounded transition-all duration-300 ${
            hasActiveFilters ? "text-red-600 hover:bg-red-50" : "text-gray-400 cursor-not-allowed"
          }`}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-3 rounded-md shadow-sm">
          ...
          <input
            ...
            className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-300"
          />
        </div>
                ...
                >
                  <input
                    ...
                    className={`h-4 w-4 focus:ring-green-500 border-gray-300 rounded transition-all duration-300 ${
                      filters.sustainablePractices.includes(practice.id) ? "text-green-600" : "text-gray-400"
                    }`}
                  />
              ...
              <div key={cropType.id} className="flex items-center">
                ...
                >
                  <input
                    ...
                    onChange={() => {}}
                    className={`h-4 w-4 focus:ring-amber-500 border-gray-300 rounded transition-all duration-300 ${
                      filters.cropTypes.includes(cropType.id) ? "text-amber-600" : "text-gray-400"
                    }`}
                  />
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {filters.sustainablePractices.map((practice) => {
              ...
              return (
                <div
                  key={practice}
                  className="flex items-center bg-green-100 text-green-800 px-2 py-1 rounded-md text-xs"
                >
                  {practiceOption?.icon}
