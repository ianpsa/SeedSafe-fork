...
const Products = () => {
  ...
  const products = {
    'future-harvest': {
      ...
      description: 'Tokens that represent fractions of future harvests, allowing producers to raise funds in advance and investors to diversify their portfolio with exposure to agricultural commodities.',
    ...
    'tco2': {
      ...
      description: 'Tokens that represent 1 ton of CO₂ sequestered or not emitted, generated through sustainable agricultural practices verified by independent third parties.',
    ...
    'combo-nft': {
      ...
      description: 'Exclusive digital certificates that prove participation in future harvests AND positive environmental impact, combining harvest fractions and carbon credits in a single token.',
    ...
    'marketplace': {
      ...
      description: 'A digital market where producers can list their future harvests and carbon credits, and investors can explore opportunities with full transparency on origin and impact.',
  ...
  return (
    <section id="products" className="py-12 px-8 bg-gray-100">
      <div className="text-center max-w-2xl mx-auto mb-12">
        ...
        <p className="text-lg text-gray-500">Innovative blockchain solutions for sustainable agribusiness</p>
      </div>
